	...
	<div class="ui one column centered grid">
		...
		<div class="ten wide computer column sixteen wide mobile">
			...
			<div class="ui three column grid">
				<div class="column"><h5 id="step1header" class="ui header">1.Chose State  <i class=" checkmark green icon"></i> </h5></div>	
				<div class="column"><h5 id="step2header" class="ui header grey">2.Chose District <i class=" checkmark green icon"></i> </h5></div>	
				<div class="column"><h5 id="step3header" class="ui header grey">3.Chose Township <i class=" checkmark green icon"></i> </h5></div>				
			</div>
