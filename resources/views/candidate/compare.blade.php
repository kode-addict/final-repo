	...
	<div class="ui two column grid segment">
	  <div class="column">
			...
			<img class="ui small bordered rounded image candidate-img" src="{{ $person->data->photo_url }}">
				...
				<p><i class="teal empire icon"></i> Father Religion : {{ $person->data->father->religion}}</p>				
				<p><i class="teal female icon"></i> Mother : {{ $person->data->mother->name}}</p>
				<p><i class="teal empire icon"></i> Mother Religion : {{ $person->data->mother->religion}}</p>				
				<p><i class="teal university icon"></i> legislature : {{ $person->data->legislature}} </p>
				<p><i class="teal flag icon"></i> ethnicity : {{ $person->data->ethnicity}}</p>
				<p><i class="teal tag icon"></i> Constituency : {{ $person->data->constituency->name}} {{ $person->data->constituency->number}}</p>
				<p><i class="teal map pin icon"></i> State : {{ $person->data->constituency->parent}}</p>
